...
export const siteData: SiteData = {
  ...
  personal: {
    ...
    resume: "/Y.SIDDHARTH.pdf",
  },

  // ━━━ ABOUT SECTION ━━━
  about: {
    description: [
      "I'm an AI/ML/DL researcher and developer passionate about pushing the boundaries of artificial intelligence. I specialize in deep learning, transformers, and neural architecture design.",
  ...
  projects: [
    {
      id: "proj-holographic",
      title: "Holographic",
      description: "Building visual intelligence using modern AI and computer vision techniques",
      longDescription: "Holographic is a project focused on exploring how machines can see, understand, and reason about images using deep learning. Features include computer vision pipelines, image processing & analysis, deep learning neural networks, with a modular and extensible codebase that's research & experimentation friendly.",
      technologies: ["Python", "OpenCV", "NumPy", "PyTorch", "TensorFlow", "Deep Learning"],
      github: "https://github.com/yourusername/holographic",
      featured: true,
      category: "ML/AI"
    },
    {
  ...
  education: [
    {
      id: "edu-1",
      degree: "Computer Science Engineering (AI, ML, DL)",
      institution: "BITS Pilani",
      location: "Pilani Campus, Rajasthan",
      period: "",
    ...
    },
    {
      ...
      institution: "Adithya Jr College",
    ...
    },
    {
      id: "edu-3",
      degree: "Schooling",
      institution: "Sri Gowthami Smart School",
      location: "Rajahmundry",
      period: "",
      description: ""
    }
